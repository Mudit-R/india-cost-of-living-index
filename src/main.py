...
def main():
    ...
    # Step 3: Save results
    print("\n[3/5] Saving results...")
    output_file = '../outputs/reports/cost_index_results.csv'
    ...
    print("  ✓ All visualizations saved to '../outputs/visualizations/' folder")
    ...
    print_separator()
    print("✓ Analysis complete! Check '../outputs/visualizations/' folder for charts.")
    print_separator()
